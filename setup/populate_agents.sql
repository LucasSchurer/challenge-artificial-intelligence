...
“Aplicações práticas da IA no dia a dia”', '{"name": "module_outline_output_format", "description": "Schema defining the structure of a module outline within a personalized learning plan.", "inputSchema": {"json": {"type": "object", "required": ["module_title", "contents"], "properties": {"contents": {"type": "array", "items": {"type": "object", "required": ["type", "content"], "properties": {"type": {"enum": ["text", "video", "image"], "type": "string", "description": "Type of content. ''text'' represents written explanations, summaries, or educational texts. ''video'' represents multimedia content such as lectures or tutorials. ''image'' represents visual aids like diagrams, charts, or infographics."}, "content": {"type": "string", "description": "A short description of what the content will cover or its learning objective."}}}, "description": "List of contents that make up this module, organized in a logical learning sequence."}, "module_title": {"type": "string", "description": "Title of the current module."}}, "additionalProperties": false}}}'::jsonb);